        ...
        {extendedPurchase.length > 0 ? (
          ...
          <div className='text-center'>
            <div className='flex justify-center flex-col'>
              <img src={noproduct} alt='no product' className='h-48 w-48 mx-auto' />
              <div className='mt-1'>Giỏ hàng của bạn còn trống </div>
              <Link to={path.home} className='mt-3 min-w-36 mx-auto bg-orange/80 px-5 py-3 uppercase text-white text-sm hover:bg-orange'>
                Mua ngay
              </Link>
            </div>
          </div>
